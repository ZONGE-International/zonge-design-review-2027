...
function sliders () {
  if ($('.owl-carousel').length) {
    var homepageAutoplayEnabled = ($('.homepage').attr('data-autoplay') || 'true') === 'true'
    var homepageAutoplayDelay = parseInt($('.homepage').attr('data-autoplay-delay'), 10) || 5500
    ...
    $('.homepage').owlCarousel({
      ...
      autoPlay: homepageAutoplayEnabled ? homepageAutoplayDelay : false,
      stopOnHover: false,
      singleItem: true,
      lazyLoad: false,
      addClassActive: true,
